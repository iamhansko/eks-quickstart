...
# eks-node-viewer
wget -q -O eks-node-viewer https://github.com/awslabs/eks-node-viewer/releases/download/v0.7.1/eks-node-viewer_Linux_x86_64
...
eksctl create addon --name eks-pod-identity-agent --cluster $CLUSTER_NAME --wait
eksctl create podidentityassociation \
--cluster $CLUSTER_NAME \
--namespace $KARPENTER_NAMESPACE \
--service-account-name karpenter \
--role-name "$CLUSTER_NAME-karpenter" \
--permission-policy-arns "arn:aws:iam::$AWS_ACCOUNT_ID:policy/KarpenterControllerPolicy-$CLUSTER_NAME"
